...
if [ ! -f "$ISTIO_ENVOY_DEBUG_PATH" ] || [ ! -f "$ISTIO_ENVOY_RELEASE_PATH" ] ; then
    ...
    cp /home/test/envoyBinaries/debug/envoy $ISTIO_ENVOY_DEBUG_DIR/usr/local/bin
    ...
    cp /home/test/envoyBinaries/release/envoy $ISTIO_ENVOY_RELEASE_DIR/usr/local/bin

...
"rhel-7.4" | "rhel-7.5" | "rhel-7.6")
	...
	sudo yum install -y hostname tar zip gcc-c++ unzip python libtool automake cmake curl wget gcc vim patch binutils-devel bzip2 make tcl gettext | tee -a "${LOG_FILE}"
	buildGCC
	buildGIT |& tee -a "$LOG_FILE"

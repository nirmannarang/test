...
rm Dockerfile.s390x
wget https://raw.githubusercontent.com/nirmannarang/test2/master/Dockerfile.s390x
cd $GOPATH/src/github.com/projectcalico/felix
...
wget https://raw.githubusercontent.com/nirmannarang/test2/master/calco/Dockerfile.s390x
